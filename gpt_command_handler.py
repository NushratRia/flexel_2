...
SYSTEM_PROMPT = (
    ...
    " - Handle common ASR mishears: treat 'margie', 'margie\\'s', 'margies', or 'march' as 'merge' when it fits a spreadsheet intent.\n"
    ...
    "  \"margie's these cells\"        -> {\"action\":\"merge\",\"range\":\"this\",\"confidence\":0.9}\n"
    "  \"march these\"                 -> {\"action\":\"merge\",\"range\":\"this\",\"confidence\":0.85}\n"
